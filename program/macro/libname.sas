...
* Define constants;
%let efficacy_group='óLå¯ê´âêÕëŒè€èWíc';
%let all_group='ëSëÃ';
%let ope_group='é°ñ¸êÿèúÇÃâêÕëŒè€èWíc';
%let ope_chemo='é°ñ¸êÿèúÅEChemotherapyåQ';
%let ope_non_chemo='é°ñ¸êÿèúÅEnon-ChemotherapyåQ';
%let non_ope_group='é°ñ¸ñ¢êÿèúÇÃâêÕëŒè€èWíc';
%let non_ope_chemo='é°ñ¸ñ¢êÿèúÅEChemotherapyåQ';
%let non_ope_non_chemo='é°ñ¸ñ¢êÿèúÅEnon-ChemotherapyåQ';
...
%macro CREATE_OUTPUT_DS(output_ds='', title_char_len=100, items_char_len=100, items_label='', output_contents_ds=ds_colnames, input_n=ds_n);
    /*  *** Functional argument ***  
        ...
        *** Example ***
        %CREATE_OUTPUT_DS(output_ds=ds_demog, items_label='îwåiÇ∆êlå˚ìùåväwìIì¡ê´');
    */
    %local cst_per;
    %let cst_per='(%)';
    proc sql;
